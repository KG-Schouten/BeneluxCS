export class FilterState {
    constructor(storageKey, selectors) {
        ...
        this.selectors = selectors;   // selectors for filter inputs
    ...
    getFilters() {
        // Return an object of current filter values, e.g. for building query params
        let minElo = 0, maxElo = 5000;
        if (this.eloSlider && this.eloSlider.noUiSlider) {
